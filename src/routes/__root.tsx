  ...
  head: () => ({
    meta: [
      ...
      { title: `${APP_NAME} — ${APP_TAGLINE}` },
      {
        name: "description",
        content:
          "Atlas is a premium personal management system for tasks, calendars, scoring and progress — engineered for focus.",
      },
      ...
      { property: "og:title", content: `${APP_NAME} — ${APP_TAGLINE}` },
      {
        ...
        content:
          "A premium personal management system for tasks, calendars, scoring and progress.",
      },
